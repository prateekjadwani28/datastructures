...
public class LL05_StartingNode {
	 ...
	 * 1 -> 2 -> 3 -> 4 -> null
	 */
	private static SinglyLinkedListNode findStartingNode(SinglyLinkedListNode head) {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int testsItr = 0; testsItr < tests; testsItr++) {
			...
			SinglyLinkedListNode result = findStartingNode(llist.head);
