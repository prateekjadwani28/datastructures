...
public class LL03_DetectLoop {
	...
	public static void main(String[] args) throws IOException {
        ...
        for (int testsItr = 0; testsItr < tests; testsItr++) {
            ...
            System.out.println("Does loop exists : "+result);
            if(result)
            	findLoopLength(llist.head);
        }
	...
	private static void findLoopLength(SinglyLinkedListNode head) {
		int count = 1;
